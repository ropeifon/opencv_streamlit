...
def principal():
	...
	taxa_borrao = st.sidebar.slider('Borrao', min_value = 0.2, max_value = 3.5)
	...
	filtro_cinza = st.sidebar.checkbox('Convertar para Escala de cinza')
